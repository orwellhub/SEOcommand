...
const BROWSER_PAGE_CHECKS=["missing_title","missing_description","missing_h1","multiple_h1","missing_canonical","not_indexable","invalid_json_ld","javascript_dependent_content","hreflang_missing_self_reference"];
