...
const CreateSchema=z.object({site:z.string().min(1),...metadata,brief:BriefSchema.default({}),initialText:z.string().max(200000).optional(),targetUrl:PublicUrlSchema.nullable().optional(),plannedUrl:z.string().trim().max(2000).nullable().optional(),analysisId:z.string().uuid().optional()});
