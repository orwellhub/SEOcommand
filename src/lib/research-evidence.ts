...
export const RESEARCH_FEATURES = [
  ...
  { id: "links", title: "Deeper backlink evidence", home: "/backlinks?view=research", description: "Up to 1,000 linking-page records per domain, with anchors and collection dates.", input: "domains" },
  ...
  { id: "recovery", title: "Recover links to broken pages", home: "/backlinks?view=recovery", description: "Find your pages with incoming links and provider-reported errors. Verify before redirecting.", input: "none" },
