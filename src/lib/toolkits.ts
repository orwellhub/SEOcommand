...
export const TOOLKITS: Toolkit[] = [
  ...
  { id: "seo", label: "SEO", icon: TrendingUp, href: "/portfolio", groups: [
    ...
    { label: "Competitive Analysis", items: [tool("/domain-research", "Domain Overview"), tool("/competitors", "Organic Rankings", ["competitors", "keyword gap"]), tool("/competitors?view=pages", "Top Pages"), tool("/pages", "Your Website Pages"), tool("/performance?view=overlap", "Compare Websites"), tool("/research?view=competitors", "Organic Competitors"), tool("/research?view=gaps", "Keyword Gap"), tool("/link-building?view=gap#link-gap", "Backlink Gap"), tool("/market-intelligence", "Market Insights")] },
    { label: "Keyword Research", items: [tool("/keyword-research", "Keyword Overview"), tool("/keyword-research?view=discover", "Keyword Magic Tool"), tool("/keyword-strategy", "Keyword Strategy Builder"), tool("/questions", "Customer Questions", ["people also ask", "paa"]), tool("/keyword-research?view=autocomplete", "Autocomplete Suggestions"), tool("/keyword-research?view=saved", "Saved Keywords"), tool("/keyword-research?view=projects", "Research Projects"), tool("/keyword-research?view=tracking", "Tracking Setup")] },
    { label: "Content Ideas", items: [tool("/content?view=editor", "SEO Writing Assistant"), tool("/questions", "Topic Research"), tool("/content?view=briefs", "SEO Content Template")] },
    { label: "Link Building", items: [tool("/backlinks", "Backlinks"), tool("/backlinks?view=referring", "Referring Domains"), tool("/backlinks?view=risk", "Backlink Audit"), tool("/backlinks?feature=links#research", "Deeper Backlink Research"), tool("/backlinks?feature=recovery#research", "Broken Backlink Recovery"), tool("/link-building", "Link Building & Outreach")] },
    ...
    { label: "Other", items: [tool("/health?view=issues", "On Page SEO Checker"), tool("/research", "Organic Traffic Insights", ["clicks", "impressions", "search console"])] },
