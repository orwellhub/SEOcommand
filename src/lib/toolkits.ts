...
export const TOOLKITS: Toolkit[] = [
  ...
  { id: "seo", label: "SEO", icon: TrendingUp, href: "/portfolio", groups: [
    ...
    { label: "Technical & Monitoring", items: [tool("/health?view=issues", "Issues & Root Causes"), tool("/health?view=speed", "Website Speed Test"), tool("/health?view=indexing", "Google Indexing"), tool("/technical-crawler", "Browser Crawl"), tool("/health?view=watchlist", "Page Watchlist"), tool("/health?view=ai", "AI Readiness", ["ai crawler access", "llms.txt", "gptbot", "ai bots", "nosnippet", "ai overviews"]), tool("/health?view=launch", "Launch & Migration"), tool("/monitoring", "Availability Monitor"), tool("/serp-intelligence", "Search Results")] },
