...
export const TOOLKITS: Toolkit[] = [
  ...
  { id: "seo", label: "SEO", icon: TrendingUp, href: "/portfolio", groups: [
    ...
    { label: "Link Building", items: [tool("/backlinks", "Backlinks"), tool("/backlinks?view=referring", "Referring Domains"), tool("/backlink-audit", "Backlink Audit"), tool("/backlinks?feature=links#research", "Deeper Backlink Research"), tool("/backlinks?feature=recovery#research", "Broken Backlink Recovery"), tool("/link-building", "Link Building & Outreach")] },
  ...
  { id: "ai", label: "AI", icon: Sparkles, href: "/ai-visibility", groups: [
    { label: "AI Analysis", items: [tool("/ai-visibility", "Visibility Overview"), tool("/ai-visibility?view=competitors", "Competitor Research"), tool("/ai-research", "Prompt Research")] },
